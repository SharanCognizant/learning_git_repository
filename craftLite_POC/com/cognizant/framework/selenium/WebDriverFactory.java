...
public class WebDriverFactory
{
	...
	/**
     * Function to return the {@link IMobileDevice} object corresponding to the Device ID passed
     * @param perfectoDeviceId The Perfecto MobileCloud Device ID
     * @return The Perfecto {@link IMobileDevice} object
     */
    /*public static IMobileDevice getDevice(String perfectoDeviceId)
    {
            MobileDriver mobileDriver = new MobileDriver(
                            properties.getProperty("PerfectoHost"),
                            properties.getProperty("PerfectoUser"),
                            properties.getProperty("PerfectoPassword"));
            IMobileDevice device = mobileDriver.getDevice(perfectoDeviceId);
            device.open();
            device.home();
