...
public class ReportTheme
{
	 ...
	 * (also used as the sub-heading/sub-section text color)
	 * @return The heading background color
	 * (also used as the sub-heading/sub-section text color)
	 */
	...
	/**
	 * Function to set the heading background color
	 * (also used as the sub-heading/sub-section text color)
	 * @param headingBackColor The heading background color
	 * (also used as the sub-heading/sub-section text color)
	 */
	...
	/**
	 * Function to get the heading text color
	 * (also used as the sub-heading/sub-section background color)
	...
	/**
	 * Function to set the heading text color
	 * (also used as the sub-heading/sub-section background color)
	 * @param headingForeColor The heading text color
	 * (also used as the sub-heading/sub-section background color)
	 */
	 ...
	 * @param sectionBackColor The section background color
	 */
	 ...
	 * @param sectionForeColor The section text color
	 */
	 ...
	 * @param contentBackColor The content background color
	 */
	...
	/**
	 * Function to get the content text color
	 * (also used as the overall background color)
	 * @return The content text color
	 * (also used as the overall background color)
	 */
	...
	/**
	 * Function to set the content text color
	 * (also used as the overall background color)
	 * @param contentForeColor The content text color
	 * (also used as the overall background color)
	 */
